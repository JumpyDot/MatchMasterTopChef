/* Gruntfile for Top Chef Memory Challenge HTML5 project production packging.
 *
 ...
 * Top Chef Memory Challenge workflow:
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        exec: {
            ...
            copyenginesismin: {
                command: 'cp distrib/lib/enginesis.min.js source/lib/enginesis.min.js && cp distrib/lib/enginesis.min.js ../../websites/enginesis/public/games/TopChefMemoryChallenge/lib/enginesis.min.js',
                stdout: true,
                stderr: true
            }
        },
